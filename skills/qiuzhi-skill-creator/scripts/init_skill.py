...
Examples:
    python scripts/init_skill.py my-new-skill --path /data/openclaw-workspace/skills
    python scripts/init_skill.py my-api-helper --path /data/openclaw-workspace/skills
"""
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        print("Usage: python scripts/init_skill.py <skill-name> --path <path>")
        print("\nExamples:")
        print("  python scripts/init_skill.py my-new-skill --path /data/openclaw-workspace/skills")
        sys.exit(1)
